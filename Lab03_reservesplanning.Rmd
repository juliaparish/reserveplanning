...
This assignment provides an introdcution to using the [`prioritizr`](https://prioritizr.net/) R package for systematic conservation planning.
...
| (i) a conservation problem object with the planning unit and biodiversity data | (ii) an object representing a solution to the problem (i.e an object in the same format as the planning unit data with values indicating if the planning units are selected or not).
